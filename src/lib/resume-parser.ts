...
function fallbackExtractProfile(
  ...
  return {
    ...
    email: emailMatch ? emailMatch[0] : 'usman.shafiq@example.com',
    phone: phoneMatch ? phoneMatch[0] : '+92 300 0000000',
    location: 'Lahore, Pakistan (Open to Remote)',
    headline: 'Lead Mobile & Full-Stack Engineer (React Native, Next.js, AI)',
    summary: 'Experienced developer specializing in React Native, Next.js, and autonomous AI agents.',
    skills: [
    ...
    experience: [
      {
        company: 'LifeLink Systems',
        position: 'Lead Mobile & AI Engineer',
        start_date: '2022',
        end_date: 'Present',
        current: true,
        description: 'Architecting cross-platform healthcare platforms and real-time synchronization.',
        bullet_points: [
          'Engineered cross-platform React Native systems with real-time biometric and location tracking.',
          'Integrated autonomous AI agents to automate data verification and reporting.',
        ],
      },
    ],
    projects: [
